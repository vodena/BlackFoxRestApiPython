...
[**upload**](RandomForestModelApi.md#upload) | **POST** /api/random-forest/model | Upload model(h5 file)
...
model_type = blackfox_restapi.RandomForestModelType() # RandomForestModelType | h5, onnx, pb (optional)
 ...
 **model_type** | [**RandomForestModelType**](.md)| h5, onnx, pb | [optional] 

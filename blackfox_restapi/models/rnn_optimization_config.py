...
class RnnOptimizationConfig(object):
    ...
    def __init__(self, dropout=None, batch_size=None, recurrent_dropout=None, recurrent_output_count=None, dataset_id=None, inputs=None, output_ranges=None, hidden_layer_count_range=None, neurons_per_layer=None, training_algorithms=None, activation_functions=None, recurrent_activation_functions=None, max_epoch=None, validation_split=None, random_seed=None, recurrent_input_count_range=None, engine_config=None, local_vars_configuration=None):  # noqa: E501

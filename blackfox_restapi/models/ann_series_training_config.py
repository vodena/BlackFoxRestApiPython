...
class AnnSeriesTrainingConfig(object):
    ...
    def __init__(self, input_window_configs=None, output_window_configs=None, output_sample_step=None, batch_size=None, dataset_id=None, input_ranges=None, output_layer=None, hidden_layer_configs=None, training_algorithm=None, max_epoch=None, cross_validation=None, validation_split=None, random_seed=None, local_vars_configuration=None):  # noqa: E501

...
class AnnSeriesOptimizationConfig(object):
    ...
    def __init__(self, input_window_range_configs=None, output_window_configs=None, output_sample_step=1, dropout=None, batch_size=512, dataset_id=None, validation_set_id=None, custom_metric_id=None, custom_metric=None, binary_classification_threshold=None, custom_metric_parameters=None, inputs=None, outputs=None, problem_type=None, binary_optimization_metric=None, regression_optimization_metric=None, hidden_layer_count_range=None, neurons_per_layer=None, training_algorithms=["Adadelta","Adagrad","Adam","Adamax","Nadam","RMSprop","SGD"], activation_functions=["Elu","HardSigmoid","Linear","ReLu","Selu","Sigmoid","SoftMax","SoftPlus","SoftSign","TanH"], max_epoch=3000, cross_validation=False, validation_split=0.2, random_seed=300, engine_config=None, custom_metric_minimization=None, use_binary_class_weight=None, local_vars_configuration=None):  # noqa: E501

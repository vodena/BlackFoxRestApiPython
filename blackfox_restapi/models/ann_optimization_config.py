...
class AnnOptimizationConfig(object):
    ...
    def __init__(self, dropout=None, batch_size=32, dataset_id=None, inputs=None, output_ranges=None, problem_type=ProblemType.REGRESSION, hidden_layer_count_range=None, neurons_per_layer=None, training_algorithms=None, activation_functions=None, max_epoch=3000, cross_validation=False, validation_split=0.2, random_seed=300, engine_config=AnnOptimizationEngineConfig(), local_vars_configuration=None):  # noqa: E501

...
class RandomForestSeriesOptimizationConfig(object):
    ...
    def __init__(self, input_window_range_configs=None, output_window_configs=None, output_sample_step=None, dataset_id=None, inputs=None, output_ranges=None, problem_type=None, validation_split=None, random_seed=None, engine_config=None, number_of_estimators=None, max_depth=None, max_features=None, local_vars_configuration=None):  # noqa: E501

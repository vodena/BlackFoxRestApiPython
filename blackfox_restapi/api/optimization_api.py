...
class OptimizationApi(object):
    ...
    def post_forest(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_forest(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_forest_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.post_forest_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def post_forest_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_forest_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/optimization/random-forest', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
